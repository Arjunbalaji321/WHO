...
import 'package:formhospi/ivdv/bloc/ivdv_bloc.dart';
import 'package:formhospi/ivdv/bloc/ivdv_event.dart';
import 'package:formhospi/ivdv/bloc/ivdv_state.dart';

class CaseIdentificationForm extends StatefulWidget {
  @override
  _CaseIdentificationFormState createState() => _CaseIdentificationFormState();
}

class _CaseIdentificationFormState extends State<CaseIdentificationForm> {
  ...
  Future<void> _selectDate(BuildContext context, String fieldName) async {
    ...
    if (pickedDate != null && pickedDate != initialDate) {
      ...
      context.read<CaseIdentificationBloc>().add(
  ...
  Widget _buildNavigationButtons() {
    return BlocBuilder<CaseIdentificationBloc, CaseIdentificationState>(
        ...
        return Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  context.read<CaseIdentificationBloc>().add(SubmitForm());
                },
                child: Text("Submit"),
              ),
            ],
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: InputDecorator(
          ...
          child: BlocBuilder<CaseIdentificationBloc, CaseIdentificationState>(
            builder: (context, state) {
