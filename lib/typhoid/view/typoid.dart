...
class _TyphoidState extends State<Typhoid> {
              ...
              ElevatedButton(
                onPressed: () {
                  if (_formKeyPage1.currentState?.validate() ?? false) {
                    ...
                    final reportedBy =
                        context.read<TyphoidBloc>().state.fields['Reported By'];
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDropdownField(
                ['Yes', 'No', 'Unknown'],
                "Antibiotic started before specimen collection:",
                "Antibiotic started before specimen collection:",
                (value) {
                  setState(() {
                    _antibioticStarted = value; // Update the state variable
                  });
                },
              ),
              if (_antibioticStarted == 'Yes') ...[
                SizedBox(height: 16),
                Text('Medication to confirm antibiotic type from label'),
                SizedBox(height: 16),
                _buildDropdownField(
                  [
                    'Ceftriaxone',
                  ...
                  "If antibiotic given, indicate which:",
                  "If antibiotic given, indicate which:",
                ),
                _buildTextField(
          ...
          children: [
            ...
            BlocBuilder<TyphoidBloc, TyphoidState>(
              builder: (context, state) {
                ...
                return Slider(
                  value: selectedNumber.toDouble(), // Current slider value
                  min: 0, // Minimum value the slider can select
                  max: 28, // Maximum value the slider can select
                  divisions: 28, // Number of discrete divisions on the slider
                  label: selectedNumber
                      .toString(), // Label showing the selected number
  ...
  Widget _buildDropdownField(List<String> items, String label, String hint,
  ...
  String? _validateNumber(String? value) {
    ...
    return number == null ? 'Please enter a valid number' : null;
  }
}
