...
import 'package:formhospi/rubella/bloc/rubella_state.dart';
import 'package:formhospi/rubella/bloc/rubella_event.dart';
  ...
  Widget _buildTextField(String labelText, String fieldName,
    ...
    return Padding(
      ...
      child: BlocBuilder<RubellaBloc, RubellaState>(
        builder: (context, state) {
          final textValue = state.fields[fieldName] as String? ?? '';
